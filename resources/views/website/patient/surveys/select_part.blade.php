    ...
    <div class="container">
        ...
        <div class="survey-container">
            @auth('doctor')
                ...
                @else
                    <a href="{{ route('patient.surveys.create', ['visit_id' => $visit_id, 'patient_id' => $patient_id, 'part' => 3]) }}"
                ...
                @else
                    <a href="{{ route('patient.surveys.create', ['visit_id' => $visit_id, 'patient_id' => $patient_id, 'part' => 4]) }}"
                       class="survey-part part-not-done">
                        Part IV: Motor Complications
                    </a>
                @endif
            ...
            @else
                ...
                @else
                    <a href="{{ route('patient.surveys.create', ['visit_id' => $visit_id, 'patient_id' => $patient_id, 'part' => 1]) }}"
                       class="survey-part part-not-done">
                ...
                @else
                    <a href="{{ route('patient.surveys.create', ['visit_id' => $visit_id, 'patient_id' => $patient_id, 'part' => 2]) }}"
                       class="survey-part part-not-done">
